...
export default function Home() {
  return (
    <div className="min-h-screen bg-[radial-gradient(circle_at_top,_rgba(255,205,227,0.9),_rgba(255,236,246,0.6)_45%,_rgba(255,250,252,0.95)_100%)] text-rose-900">
      <div className="relative isolate overflow-hidden">
        ...
        <div className="pointer-events-none absolute top-40 right-10 h-44 w-44 rounded-full bg-pink-200/70 blur-3xl" />
        <div className="pointer-events-none absolute bottom-10 left-10 h-56 w-56 rounded-full bg-amber-100/80 blur-3xl" />
        ...
        <main className="relative mx-auto flex min-h-screen w-full max-w-5xl flex-col items-center justify-center gap-10 px-6 py-20 text-center">
          <span className="inline-flex items-center gap-2 rounded-full bg-white/80 px-4 py-2 text-xs font-semibold uppercase tracking-[0.3em] text-rose-600 shadow-sm">
            <FiHeart />
            imposter game
          </span>
          <h1 className="font-[var(--font-display)] text-4xl font-semibold text-rose-950 sm:text-6xl">
            Ready for a soft-pink imposter night?
          </h1>
          <p className="max-w-2xl text-base text-rose-700 sm:text-lg">
            Build your crew, stack the categories, and pass the phone around to
            reveal who got the secret word.
          </p>
          ...
          <div className="mt-10 grid w-full gap-4 sm:grid-cols-3">
            <div className="rounded-2xl border border-white/70 bg-white/80 p-4 text-left text-sm text-rose-700 shadow-sm">
              <p className="font-semibold text-rose-900">1. Set the cast</p>
              <p className="mt-1">Toggle who is playing and add new names.</p>
            </div>
            <div className="rounded-2xl border border-white/70 bg-white/80 p-4 text-left text-sm text-rose-700 shadow-sm">
              <p className="font-semibold text-rose-900">2. Stack categories</p>
              <p className="mt-1">Pick the topics and fill them with words.</p>
            </div>
            <div className="rounded-2xl border border-white/70 bg-white/80 p-4 text-left text-sm text-rose-700 shadow-sm">
              <p className="font-semibold text-rose-900">3. Reveal roles</p>
